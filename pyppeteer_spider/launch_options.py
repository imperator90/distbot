...
def get_launch_options(headless: bool, incognito: bool, disable_images: bool,
    ...
    if browser_memory_limit:
        launch_args.append(f'--js-flags="--max_old_space_size={browser_memory_limit}"')
    if user_data_dir:
    ...
    launch_options['defaultViewport'] = default_viewport if default_viewport else {}
